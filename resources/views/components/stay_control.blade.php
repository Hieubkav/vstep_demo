{{-- 
  Bắt đầu component.
  Component này bao gồm hai phần: "How We Work" và "Client Dashboard".
  Để sử dụng: @include('sections.how-we-work-and-dashboard')
  Lưu ý: Phần "How We Work" yêu cầu JavaScript để hoạt động đầy đủ.
--}}
